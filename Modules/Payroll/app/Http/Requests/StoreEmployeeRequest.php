...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cnic' => 'required|string|unique:employees,cnic|max:20',
            // 'dob' => 'required|date',
            ...
            'contacts.*.type' => 'nullable|in:personal,work,emergency,home', // Changed 'other' to 'home' to match your form
            'contacts.*.phone' => 'nullable|string|max:20',
            'contacts.*.email' => 'nullable|email|max:255',
            'contacts.*.address' => 'nullable|string',

            // Banks validation - fixed field names to match your form

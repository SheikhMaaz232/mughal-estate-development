...
class StoreShiftRequest extends FormRequest
{
    ...
    {
        return [
            'shift_name_en' => 'required|string|max:200|unique:shifts,shift_name_en',
            'shift_name_ur' => 'required|string|max:200|unique:shifts,shift_name_ur',
    ...
    public function messages()
    {
        return [
            ...
            'shift_name_en.unique' => 'This shift in urdu name already exists.',
            ...
            'shift_name_ur.unique' => 'This shift name already exists.',

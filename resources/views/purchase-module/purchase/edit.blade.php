                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="remarks_en" name="remarks_en"
                            placeholder="@lang('messages.remarks') @lang('messages.english')" autocomplete="off">{{ old('remarks_en', $purchaseMaster->remarks_en) }}</textarea>
                        @error('remarks_en')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="remarks_ur" name="remarks_ur"
                            placeholder="@lang('messages.remarks') @lang('messages.urdu')" autocomplete="off">{{ old('remarks_ur', $purchaseMaster->remarks_ur) }}</textarea>
                        @error('remarks_ur')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    ...
                                                    <textarea name="detail_remarks_en[]" class="form-control detail_remarks_en_{{ $index }}" rows="2"
                                                        placeholder="@lang('messages.remarks')">{{ $purchaseDetail->detail_remarks_en }}</textarea>
                                                </td>
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <textarea name="detail_remarks_ur[]" class="form-control detail_remarks_ur_{{ $index }}" rows="2"
                                                        placeholder="@lang('messages.remarks')">{{ $purchaseDetail->detail_remarks_ur }}</textarea>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif

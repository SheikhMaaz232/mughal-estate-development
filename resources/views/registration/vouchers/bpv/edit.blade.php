...
@section('content')
    <div class="block block-rounded col-md-12">
        ...
        <div class="block-content block-content-full">
            <form action="{{ route('bank-payment-voucher.update', $bankPaymentVoucher->id) }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="date"
                            value="{{ $bankPaymentVoucher->date ?? now()->format('Y-m-d') }}">
                        @error('date')
                        ...
                        <select name="project_id" id="project_id"
                            ...
                            @foreach ($projects as $project)
                                <option value="{{ $project->id }}"
                                    {{ (old('project_id') ?? $bankPaymentVoucher->project_id) == $project->id ? 'selected' : '' }}>
                        ...
                        <select name="detail_account_id" id="detail_account_id"
                            ...
                            @foreach ($coaPayables as $coaPayable)
                                <option value="{{ $coaPayable->id }}"
                                    {{ (old('detail_account_id') ?? $bankPaymentVoucher->detail_account_id) == $coaPayable->id ? 'selected' : '' }}>
                ...
                <div class="row">
                        ...
                        <select name="bank_id" id="bank_id"
                            ...
                            @foreach ($coaBanks as $coaBank)
                                <option value="{{ $coaBank->id }}"
                                    {{ (old('bank_id') ?? $bankPaymentVoucher->bank_id) == $coaBank->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="total_amount" name="total_amount" step="any"
                            ...
                            value="{{ old('total_amount', $bankPaymentVoucher->total_amount ?? '') }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" id="description_en" name="description_en" placeholder="......" rows="3">{{ old('description_en', $bankPaymentVoucher->description_en ?? '') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" id="description_ur" name="description_ur" placeholder="......" rows="3">{{ old('description_ur', $bankPaymentVoucher->description_ur ?? '') }}</textarea>

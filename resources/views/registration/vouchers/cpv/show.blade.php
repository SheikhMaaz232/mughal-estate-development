...
@section('content')
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title text-primary">
                <i class="fa fa-building me-1"></i>@lang('messages.cpv_voucher_details')
            </h3>
            <div class="block-options">
                <a href="{{ route('cash-payment-voucher.edit', $cashPaymentVoucher->id) }}"
                    class="btn btn-sm btn-alt-primary">
                    <i class="fa fa-edit me-1"></i>@lang('messages.edit-cpv')
                </a>
            </div>
        </div>
        <div class="block-content">
            <div class="row">
                <!-- cashPaymentVoucher Information Card -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        CPV-{{ $cashPaymentVoucher->id ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.Date')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? \Carbon\Carbon::parse($cashPaymentVoucher->date ?? __('messages.no_available'))->format('d m Y') ?? __('messages.no_available') : \Carbon\Carbon::parse($cashPaymentVoucher->date ?? __('messages.no_available'))->format('d M Y') ?? __('messages.no_available') }}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashPaymentVoucher->project->name_ur ?? __('messages.no_available') : $cashPaymentVoucher->project->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.detail_account')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashPaymentVoucher->detailAccount->name_ur ?? __('messages.no_available') : $cashPaymentVoucher->detailAccount->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.cash_accounts')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashPaymentVoucher->cash->name_ur ?? __('messages.no_available') : $cashPaymentVoucher->cash->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.total_amount')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashPaymentVoucher->total_amount ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashPaymentVoucher->description_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.description') @lang('messages.urdu')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashPaymentVoucher->description_ur ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- cashPaymentVoucher Main Image -->
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    @if ($cashPaymentVoucher->attachment)
                                        <div id="mapContainer"
                                            style="width:100%; height:350px; background:#f8f9fa;
                                                    display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            <img id="cashPaymentVoucherMapThumb"
                                                src="{{ asset('storage/' . $cashPaymentVoucher->attachment) }}"
                ...
                <div id="imageModal"
                    ...
                    <div id="zoomContainer"
                        ...
                        <img id="zoomImage" src="{{ asset('storage/' . $cashPaymentVoucher->attachment) }}"
                            alt="Zoomed Image"
            ...
            <!-- Back Button -->
            <div class="mb-4">
                <a href="{{ route('cash-payment-voucher.index') }}" class="btn btn-alt-secondary">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const thumb = document.getElementById("cashPaymentVoucherMapThumb");

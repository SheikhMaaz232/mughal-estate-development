...
@section('content')
    <div class="block block-rounded col-md-12">
        ...
        <div class="block-content block-content-full">
            <form action="{{ route('cash-payment-voucher.update', $cashPaymentVoucher->id) }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="date"
                            value="{{ $cashPaymentVoucher->date ?? now()->format('Y-m-d') }}">
                        @error('date')
                        ...
                        <select name="project_id" id="project_id"
                            ...
                            @foreach ($projects as $project)
                                <option value="{{ $project->id }}"
                                    {{ (old('project_id') ?? $cashPaymentVoucher->project_id) == $project->id ? 'selected' : '' }}>
                        ...
                        <select name="detail_account_id" id="detail_account_id"
                            ...
                            @foreach ($coaPayables as $coaPayable)
                                <option value="{{ $coaPayable->id }}"
                                    {{ (old('detail_account_id') ?? $cashPaymentVoucher->detail_account_id) == $coaPayable->id ? 'selected' : '' }}>
                ...
                <div class="row">
                        ...
                        <select name="cash_account_id" id="cash_account_id"
                            ...
                            @foreach ($coaCashAccounts as $coaCashAccount)
                                <option value="{{ $coaCashAccount->id }}"
                                    {{ (old('cash_account_id') ?? $cashPaymentVoucher->cash_account_id) == $coaCashAccount->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="total_amount" name="total_amount" step="any"
                            ...
                            value="{{ old('total_amount', $cashPaymentVoucher->total_amount ?? '') }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" id="description_en" name="description_en" placeholder="......" rows="3">{{ old('description_en', $cashPaymentVoucher->description_en ?? '') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" id="description_ur" name="description_ur" placeholder="......" rows="3">{{ old('description_ur', $cashPaymentVoucher->description_ur ?? '') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div id="imagePreview" class="mt-2">
                                ...
                                <img id="previewImg"
                                    src="{{ isset($cashPaymentVoucher) && $cashPaymentVoucher->attachment ? asset('storage/' . $cashPaymentVoucher->attachment) : asset('images/No-Image-Placeholder.svg.png') }}"
                ...
                <div class="row">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="{{ route('cash-payment-voucher.index') }}" class="btn btn-dark">@lang('messages.go-to-list')</a>
                    </div>
                </div>
   ...
   <script>
            ...
            var config = {
                routes: {
                    getCashAccountsDetailAccounts: "{{ route('get.cash.detail.account', ['projectId' => ':id']) }}",
                }
            };
        </script>
        <script src="{{ asset('js/cPVouchers.js') }}"></script>
@endsection

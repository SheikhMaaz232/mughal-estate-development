    ...
    @section('content')
        <div class="block block-rounded col-md-12">
            <div class="block-header block-header-default">
                <h3 class="block-title">@lang('messages.brv')</h3>
            </div>
            <div class="block-content block-content-full">
                <form action="{{ route('bank-receipt-voucher.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="date" class="form-label">@lang('messages.voucher_no')</label>

                            <input class="form-control" name="date" value="BRV-{{ $maxid }}" disabled>
                        </div>
                        <div class="col-md-6 mb-3">

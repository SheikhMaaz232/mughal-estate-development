...
@section('content')
    <div class="block block-rounded">
        ...
        <div class="block-content">
            <div class="row">
                <!-- bankReceiptVoucher Information Card -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        BRV-{{ $bankReceiptVoucher->id ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.Date')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? \Carbon\Carbon::parse($bankReceiptVoucher->date ?? __('messages.no_available'))->format('d m Y') ?? __('messages.no_available') : \Carbon\Carbon::parse($bankReceiptVoucher->date ?? __('messages.no_available'))->format('d M Y') ?? __('messages.no_available') }}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $bankReceiptVoucher->project->name_ur ?? __('messages.no_available') : $bankReceiptVoucher->project->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.detail_account')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $bankReceiptVoucher->detailAccount->name_ur ?? __('messages.no_available') : $bankReceiptVoucher->detailAccount->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $bankReceiptVoucher->bank->name_ur ?? __('messages.no_available') : $bankReceiptVoucher->bank->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.total_amount')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $bankReceiptVoucher->total_amount ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ $bankReceiptVoucher->description_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.description') @lang('messages.urdu')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $bankReceiptVoucher->description_ur ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- bankReceiptVoucher Main Image -->
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    @if ($bankReceiptVoucher->attachment)
                                        <div id="mapContainer"
                                            style="width:100%; height:350px; background:#f8f9fa;
                                                    display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            <img id="bankReceiptVoucherMapThumb"
                                                src="{{ asset('storage/' . $bankReceiptVoucher->attachment) }}"
                ...
                <div id="imageModal"
                    ...
                    <div id="zoomContainer"
                        ...
                        <img id="zoomImage" src="{{ asset('storage/' . $bankReceiptVoucher->attachment) }}"
                            alt="Zoomed Image"
            ...
            <!-- Back Button -->
            <div class="mb-4">
                <a href="{{ route('bank-receipt-voucher.index') }}" class="btn btn-alt-secondary">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const thumb = document.getElementById("bankReceiptVoucherMapThumb");

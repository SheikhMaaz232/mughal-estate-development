    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title text-primary">
                <i class="fa fa-building me-1"></i>@lang('messages.crv_voucher_details')
            </h3>
            <div class="block-options">
                <a href="{{ route('cash-receipt-voucher.edit', $cashReceiptVoucher->id) }}"
                    class="btn btn-sm btn-alt-primary">
                    <i class="fa fa-edit me-1"></i>@lang('messages.edit-crv')
                </a>
            </div>
        </div>
        <div class="block-content">
            <div class="row">
                <!-- cashReceiptVoucher Information Card -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        CRV-{{ $cashReceiptVoucher->id ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.Date')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? \Carbon\Carbon::parse($cashReceiptVoucher->date ?? __('messages.no_available'))->format('d m Y') ?? __('messages.no_available') : \Carbon\Carbon::parse($cashReceiptVoucher->date ?? __('messages.no_available'))->format('d M Y') ?? __('messages.no_available') }}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashReceiptVoucher->project->name_ur ?? __('messages.no_available') : $cashReceiptVoucher->project->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.detail_account')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashReceiptVoucher->detailAccount->name_ur ?? __('messages.no_available') : $cashReceiptVoucher->detailAccount->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ App::getLocale() === 'ur' ? $cashReceiptVoucher->cash->name_ur ?? __('messages.no_available') : $cashReceiptVoucher->cash->name_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.total_amount')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashReceiptVoucher->total_amount ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashReceiptVoucher->description_en ?? __('messages.no_available') }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-muted mb-3">@lang('messages.description') @lang('messages.urdu')</h5>
                                    <div class="p-3 bg-light rounded">
                                        {{ $cashReceiptVoucher->description_ur ?? __('messages.no_available') }}
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- cashReceiptVoucher Main Image -->
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    @if ($cashReceiptVoucher->attachment)
                                        <div id="mapContainer"
                                            style="width:100%; height:350px; background:#f8f9fa;
                                                    display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            <img id="cashReceiptVoucherMapThumb"
                                                src="{{ asset('storage/' . $cashReceiptVoucher->attachment) }}"
                ...
                <div id="imageModal"
                    ...
                    <div id="zoomContainer"
                        ...
                        <img id="zoomImage" src="{{ asset('storage/' . $cashReceiptVoucher->attachment) }}"
                            alt="Zoomed Image"

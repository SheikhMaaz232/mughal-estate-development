            ...
            <div class="row">
                <div class="col-md-3 mx-auto">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="name_en" class="form-control" maxlength="100" value="{{ $unit->name_en }}" value="{{ old('name_en', $unit->name_en ?? '') }}" autocomplete="off">
                        @error('name_en')
                    ...
                    <div class="form-group mb-4 text-end">
                        ...
                        <input type="text" name="name_ur" class="form-control keyboardInput" maxlength="100" id="name_ur" value="{{ $unit->name_ur }}" dir="rtl" data-keyboard-id="keyboard-name-ur" value="{{ old('name_ur', $unit->name_ur ?? '') }}" autocomplete="off">

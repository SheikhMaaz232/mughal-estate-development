...
@section('content')
    ...
    <div class="content">
        ...
        <form method="GET" action="{{ route('registry-order.bookingListing') }}">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6" style="margin-top: 25px;">
                    ...
                    @if (request()->hasAny(['search', 'project_id']))
                        <a href="{{ route('registry-order.bookingListing') }}" class="btn btn-secondary">@lang('messages.clear')</a>
                    @endif
                </div>
            </div>
        </form>
                                ...
                                <td class="text-left">
                                    ...
                                    <a href="{{ route('registry-order.create', ['id' => $booking->id]) }}"
                                        ...
                                        aria-label="View Booking" data-bs-original-title="View Booking"><i
                                            class="fa fa-file-alt me-1"></i> @lang('messages.registry-letter')

    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-3">@lang('messages.companies')</h1>
                <h2 class="fs-base lh-base fw-medium text-muted mb-0">@lang('messages.list-of-all-companies')</h2>
            </div>
            <a href="{{ route('companies.create') }}" class="btn btn-sm btn-primary">@lang('messages.add-new')</a>

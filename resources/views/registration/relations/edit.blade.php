...
@section('content')
    <div class="block block-rounded col-md-12">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.edit-relation')</h3>
        </div>
                    ...
                    <div class="col-md-3 mx-auto">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name_en" class="form-control" maxlength="100"
                                value="{{ $relation->name_en }}" value="{{ old('name_en', $relation->name_en ?? '') }}"
                                autocomplete="off">
                            @error('name_en')
                        ...
                        <div class="form-group mb-4 text-end">
                            ...
                            <input type="text" name="name_ur" class="form-control keyboardInput" maxlength="100"
                                id="name_ur" value="{{ $relation->name_ur }}" dir="rtl"
                                data-keyboard-id="keyboard-name-ur" value="{{ old('name_ur', $relation->name_ur ?? '') }}"
                                autocomplete="off">
                            <div id="keyboard-name-ur" class="simple-keyboard mt-2 keyboard-container"

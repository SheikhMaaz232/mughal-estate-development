    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-4">@lang('messages.manage-departments')</h1>
                <h2 class="fs-base lh-base fw-medium text-muted mb-0">@lang('messages.list-of-departments')</h2>
            </div>
            <a href="{{ route('departments.create') }}" class="btn btn-sm btn-primary">@lang('messages.add-new')</a>
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>@lang('messages.department-type')</th>
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <!-- Delete Form -->
                            <form method="POST" action="{{ route('departments.destroy', $department->id) }}" class="d-inline-block delete-form">
                                @csrf
                                @method('DELETE')

...
<div class="block block-rounded col-md-12">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('messages.add-schedule-period') </h3>
    </div>
    <div class="block-content block-content-full">
        ...
        <form action="{{ route('periods.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-3 mx-auto">
                    ...
                    <div class="form-group mb-4 text-end">
                        <label for="title_ur">اردو @lang('messages.title') </label>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('periods.index') }}" class="btn btn-sm btn-alt-primary">@lang('messages.go-to-list')</a>
            </div>
        </form>
    </div>
</div>

...
@section('content')
    <div class="block block-rounded col-md-12">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.add-sub-heads')</h3>
        </div>
        <div class="block-content block-content-full">
            <form action="{{ route('sub-heads.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control input-urdu keyboardInput" id="name_ur"
                                name="name_ur" placeholder="نام درج کریں" autocomplete="off">
                            @error('name_ur')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('sub-heads.index') }}" class="btn btn-dark">@lang('messages.go-to-list')</a>
                        </div>
                    </div>
                </div>
            </form>

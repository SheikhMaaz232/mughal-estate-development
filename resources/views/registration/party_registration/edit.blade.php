...
@section('content')
    <div class="block block-rounded col-md-12">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.edit-parties')</h3>
        </div>
        <div class="block-content block-content-full">
            <form action="{{ route('parties.update', $registeredParty->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="name_en" name="name_en"
                            value="{{ old('name_en', $registeredParty->name_en ?? '') }}" placeholder="@lang('messages.enter-name-english')"
                            autocomplete="off">
                        @error('name_en')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control input-urdu keyboardInput" id="name_ur" name="name_ur"
                            value="{{ old('name_ur', $registeredParty->name_ur ?? '') }}" placeholder="نام درج کریں"
                            autocomplete="off">
                        @error('name_ur')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="father_name_en" name="father_name_en"
                            value="{{ old('father_name_en', $registeredParty->father_name_en ?? '') }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control input-urdu keyboardInput" id="father_name_ur"
                            ...
                            value="{{ old('father_name_ur', $registeredParty->father_name_ur ?? '') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cnic_no" name="cnic_no"
                            placeholder="12345-1234567-1" maxlength="15" placeholder="@lang('messages.cnic_no')" autocomplete="off"
                            value="{{ old('cnic_no', $registeredParty->cnic_no ?? '') }}">
                        @error('cnic_no')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="ntn_no" name="ntn_no"
                            placeholder="@lang('messages.ntn_no')" autocomplete="off"
                            value="{{ old('ntn_no', $registeredParty->ntn_no ?? '') }}">
                        @error('ntn_no')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="gst_no" name="gst_no"
                            placeholder="@lang('messages.gst_no')" autocomplete="off"
                            value="{{ old('gst_no', $registeredParty->gst_no ?? '') }}">
                        @error('gst_no')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="business_name_en" name="business_name_en"
                            placeholder="@lang('messages.enter-name-english')" autocomplete="off"
                            value="{{ old('business_name_en', $registeredParty->business_name_en ?? '') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control input-urdu keyboardInput" id="business_name_ur"
                            ...
                            value="{{ old('business_name_ur', $registeredParty->business_name_ur ?? '') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="business_address_en" name="business_address_en"
                            placeholder="@lang('messages.address')" autocomplete="off">{{ $registeredParty->business_address_en ?? '' }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control input-urdu keyboardInput" id="business_address_ur"
                            name="business_address_ur" placeholder="کاروبار کا پتہ درج کریں" autocomplete="off">{{ $registeredParty->business_address_ur ?? '' }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="home_address_en" name="home_address_en"
                            placeholder="@lang('messages.address')" autocomplete="off">{{ $registeredParty->home_address_en ?? '' }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control input-urdu keyboardInput" id="home_address_ur" name="home_address_ur"
                            placeholder="کاروبار کا پتہ درج کریں" autocomplete="off">{{ $registeredParty->home_address_ur ?? '' }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_no_1" name="contact_number_1"
                            ...
                            value="{{ old('contact_number_1', $registeredParty->contact_number_1 ?? '') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_no_2" name="contact_number_2"
                            placeholder="@lang('messages.contact_no')" autocomplete="off"
                            value="{{ old('contact_number_2', $registeredParty->contact_number_2 ?? '') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="whatsApp_no" name="whatsApp_no"
                            placeholder="@lang('messages.whatsapp_no')" autocomplete="off"
                            value="{{ old('whatsApp_no', $registeredParty->whatsApp_no ?? '') }}">
                        @error('whatsApp_no')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="remarks" name="remarks" placeholder="@lang('messages.remarks')"
                            autocomplete="off">{{ $registeredParty->remarks ?? '' }}</textarea>
                        @error('remarks')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div id="imagePreview" class="mt-2">
                                ...
                                <img id="previewImg"
                                    src="{{ isset($registeredParty) && $registeredParty->cnic_front_image ? asset('storage/' . $registeredParty->cnic_front_image) : asset('images/No-Image-Placeholder.svg.png') }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div id="imagePreview2" class="mt-2">
                                {{--  <p class="mb-1">@lang('messages.image-preview')</p>  --}}
                                <img id="previewImg2"
                                    src="{{ isset($registeredParty) && $registeredParty->cnic_back_image ? asset('storage/' . $registeredParty->cnic_back_image) : asset('images/No-Image-Placeholder.svg.png') }}"
                                    alt="" class="img-thumbnail" style="max-height: 200px;">
                            </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div id="imagePreview3" class="mt-2">
                                {{--  <p class="mb-1">@lang('messages.image-preview')</p>  --}}
                                <img id="previewImg3"
                                    src="{{ isset($registeredParty) && $registeredParty->profile_image ? asset('storage/' . $registeredParty->profile_image) : asset('images/No-Image-Placeholder.svg.png') }}"
                                    alt="" class="img-thumbnail" style="max-height: 200px;">
                            </div>
                    ...
                    <div class="invoice-detail-items" style="padding: 0px 0px 0px 0px !important;">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table item-table">
                                ...
                                <tbody>
                                    @foreach ($partyBanks as $partyBank)
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td class="product">
                                                <select id="bank_id" name="bank_id[]"
                                                    class="mb-3 form-control select2 custom-select {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} bank_{{ $index }}">
                                                    <option selected="">@lang('messages.select-bank')</option>
                                                    @foreach ($banks as $bank)
                                                        <option value="{{ $bank->id }}"
                                                            {{ old('bank_id.' . $index) == $bank->id || (!empty($partyBank->bank_id) && $partyBank->bank_id == $bank->id) ? 'selected' : '' }}>
                                                            {{ app()->getLocale() == 'ur' ? $bank->name_ur : $bank->name_en }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td class="account_title">
                                                <input type="text" style="color: black;"
                                                    class="account_title form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}  account_title_{{ $index }}"
                                                    id="account_title" value="{{ $partyBank->account_title }}"
                                                    name="account_title[]" placeholder="@lang('messages.account_title')">
                                            </td>
                                            <td class="account_number">
                                                <input type="text" style="color: black;"
                                                    class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} account_number_{{ $index }}"
                                                    placeholder="@lang('messages.account_number')"
                                                    value="{{ $partyBank->account_number }}" name="account_number[]"
                                                    id="account_number">
                                            </td>

                                            <td class="text-right branch_code">
                                                <input id="branch_code" type="branch_code" name="branch_code[]"
                                                    value="{{ $partyBank->branch_code ?? 0 }}"
                                                    placeholder="@lang('messages.branch_code')"
                                                    class="branch_code form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} branch_code_{{ $index }}">
                                            </td>
    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                currentIndex + '" placeholder="@lang('messages.edit-parties')" ></td>' +
                '<td class="account_number" >' +
                '<input type="text" style="color: black; " placeholder="@lang('messages.name')" id="account_number" name="account_number[]" class = "account_number form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} account_number_' +
                currentIndex + '" > </td> ' +
                '<td class="text-right branch_code">' +
                ...
                currentIndex + '" placeholder="@lang('messages.english') ">' +
                ' </td>' +

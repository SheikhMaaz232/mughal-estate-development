...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('messages.edit-construction-site')</h3>
    </div>
    <div class="block-content block-content-full">
        <form action="{{ route('construction-sites.update', $site->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="company_id" id="company_id" class="form-control select2 custom-select form-select @error('company_id') is-invalid @enderror">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="project_id" id="project_id" class="form-control select2 custom-select form-select @error('project_id') is-invalid @enderror">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="party_id" id="party_id" class="form-control select2 custom-select form-select @error('party_id') is-invalid @enderror">
                        ...
                        @foreach ($parties ?? [] as $party)
                            <option value="{{ $party->id }}" {{ old('party_id', $site->party_id) == $party->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="status" id="status" class="form-control select2 custom-select form-select @error('status') is-invalid @enderror">
                        ...
                        <option value="pending" {{ old('status', $site->status) == 'pending' ? 'selected' : '' }}>@lang('messages.pending')</option>
                        <option value="ongoing" {{ old('status', $site->status) == 'ongoing' ? 'selected' : '' }}>@lang('messages.ongoing')</option>
                        <option value="completed" {{ old('status', $site->status) == 'completed' ? 'selected' : '' }}>@lang('messages.completed')</option>
                        <option value="on-hold" {{ old('status', $site->status) == 'on-hold' ? 'selected' : '' }}>@lang('messages.on-hold')</option>
                    </select>
                    @error('status')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="name_en" id="name_en" class="form-control @error('name_en') is-invalid @enderror"
                        value="{{ old('name_en', $site->name_en) }}" placeholder="@lang('messages.enter-name-english')" maxlength="255">
                    @error('name_en')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-4 text-end">
                    ...
                    <input type="text" name="name_ur" id="name_ur" class="form-control keyboardInput @error('name_ur') is-invalid @enderror"
                        value="{{ old('name_ur', $site->name_ur) }}" dir="rtl" data-keyboard-id="keyboard-name-ur" placeholder="@lang('messages.enter-name-urdu')" maxlength="255" autocomplete="off">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea name="description_en" id="description_en" class="form-control @error('description_en') is-invalid @enderror"
                        rows="3" placeholder="@lang('messages.enter-description-english')">{{ old('description_en', $site->description_en) }}</textarea>
                ...
                <div class="col-md-12 mb-4 text-end">
                    ...
                    <textarea name="description_ur" id="description_ur" class="form-control keyboardInput @error('description_ur') is-invalid @enderror"
                        rows="3" dir="rtl" data-keyboard-id="keyboard-description-ur" placeholder="@lang('messages.enter-description-urdu')" autocomplete="off">{{ old('description_ur', $site->description_ur) }}</textarea>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea name="address_en" id="address_en" class="form-control @error('address_en') is-invalid @enderror"
                        rows="3" placeholder="@lang('messages.enter-address-english')">{{ old('address_en', $site->address_en) }}</textarea>
                    @error('address_en')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-4 text-end">
                    ...
                    <textarea name="address_ur" id="address_ur" class="form-control keyboardInput @error('address_ur') is-invalid @enderror"
                        rows="3" dir="rtl" data-keyboard-id="keyboard-address-ur" placeholder="@lang('messages.enter-address-urdu')" autocomplete="off">{{ old('address_ur', $site->address_ur) }}</textarea>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="date" name="estimated_start_date" id="estimated_start_date" class="form-control @error('estimated_start_date') is-invalid @enderror"
                        value="{{ old('estimated_start_date', $site->estimated_start_date?->format('Y-m-d')) }}">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="date" name="estimated_end_date" id="estimated_end_date" class="form-control @error('estimated_end_date') is-invalid @enderror"
                        value="{{ old('estimated_end_date', $site->estimated_end_date?->format('Y-m-d')) }}">

            ...
            <form action="{{ route('work-orders.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control"
                            value="{{ App::getLocale() === 'ur' ? $boqMaster->tender->title_ur : $boqMaster->tender->title_en }}"
                            disabled>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control"
                            value="{{ App::getLocale() === 'ur' ? $boqMaster->title_ur : $boqMaster->title_en }}" disabled>
                        <input type="hidden" name="boq_id" value="{{ $boqMaster->id }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">@lang('messages.total_amount')</label>
                        <input type="text" class="form-control" value="{{ number_format($boqMaster->total_amount, 2) }}"
                            disabled>
                    </div>
                </div>

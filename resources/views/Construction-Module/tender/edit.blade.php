...
@section('content')
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.edit-tender')</h3>
        </div>
            ...
            <form action="{{ route('tenders.update', $tender->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control" style="background-color: #e9ecef !important;"
                            name="construction_site_id" value="{{ $tender->construction_site_id }}" readonly>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="draft" {{ old('status', $tender->status) == 'draft' ? 'selected' : '' }}>
                                @lang('messages.draft')</option>
                            <option value="approved" {{ old('status', $tender->status) == 'approved' ? 'selected' : '' }}>
                                @lang('messages.approved')</option>
                            <option value="in_progress"
                                {{ old('status', $tender->status) == 'in_progress' ? 'selected' : '' }}>@lang('messages.in-progress')
                            </option>
                            <option value="completed" {{ old('status', $tender->status) == 'completed' ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="contractee_account_id" id="contractee_account_id"
                            class="form-control select2 custom-select form-select @error('contractee_account_id') is-invalid @enderror">
                            <option value="">@lang('messages.select-contractee-account')</option>
                            @foreach ($detailAccounts as $account)
                                <option value="{{ $account->id }}"
                                    {{ old('contractee_account_id', $tender->contractee_account_id) == $account->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="contractor_account_id" id="contractor_account_id"
                            class="form-control select2 custom-select form-select @error('contractor_account_id') is-invalid @enderror">
                            <option value="">@lang('messages.select-contractor-account')</option>
                            @foreach ($detailAccounts as $account)
                                <option value="{{ $account->id }}"
                                    {{ old('contractor_account_id', $tender->contractor_account_id) == $account->id ? 'selected' : '' }}>
                                    {{ App::getLocale() === 'ur' ? $account->name_ur : $account->name_en }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="revenue_account_id" id="revenue_account_id"
                            class="form-control select2 custom-select form-select @error('revenue_account_id') is-invalid @enderror">
                            <option value="">@lang('messages.select-revenue-account')</option>
                            @foreach ($detailAccounts as $account)
                                <option value="{{ $account->id }}"
                                    {{ old('revenue_account_id', $tender->revenue_account_id) == $account->id ? 'selected' : '' }}>
                                    {{ App::getLocale() === 'ur' ? $account->name_ur : $account->name_en }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="expense_account_id" id="expense_account_id"
                            class="form-control select2 custom-select form-select @error('expense_account_id') is-invalid @enderror">
                            <option value="">@lang('messages.select-expense-account')</option>
                            @foreach ($detailAccounts as $account)
                                <option value="{{ $account->id }}"
                                    {{ old('expense_account_id', $tender->expense_account_id) == $account->id ? 'selected' : '' }}>
                                    {{ App::getLocale() === 'ur' ? $account->name_ur : $account->name_en }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="title_en" id="title_en"
                            ...
                            value="{{ old('title_en', $tender->title_en) }}" placeholder="@lang('messages.enter-title-english')"
                            maxlength="255">
                        @error('title_en')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-4 text-end">
                        ...
                        <input type="text" name="title_ur" id="title_ur"
                            ...
                            value="{{ old('title_ur', $tender->title_ur) }}" dir="rtl"
                            data-keyboard-id="keyboard-title-ur" placeholder="@lang('messages.enter-title-urdu')" maxlength="255"
                            autocomplete="off">
                        <div id="keyboard-title-ur" class="simple-keyboard mt-2 keyboard-container" style="display: none;">
                        </div>
                        @error('title_ur')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea name="description_en" id="description_en"
                            ...
                            placeholder="@lang('messages.enter-description-english')">{{ old('description_en', $tender->description_en) }}</textarea>
                    ...
                    <div class="col-md-12 mb-4 text-end">
                        ...
                        <textarea name="description_ur" id="description_ur"
                            ...
                            data-keyboard-id="keyboard-description-ur" placeholder="@lang('messages.enter-description-urdu')" autocomplete="off">{{ old('description_ur', $tender->description_ur) }}</textarea>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="work_type" id="work_type"
                            ...
                            value="{{ old('work_type', $tender->work_type) }}" placeholder="@lang('messages.enter-work-type')"
                            maxlength="255">
                        @error('work_type')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" name="estimated_cost" id="estimated_cost"
                            ...
                            value="{{ old('estimated_cost', $tender->estimated_cost) }}" placeholder="@lang('messages.enter-estimated-cost')"
                            step="0.01" min="0">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" name="start_date" id="start_date"
                            ...
                            value="{{ old('start_date', $tender->start_date?->format('Y-m-d')) }}">
                        @error('start_date')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>

...
@section('content')
        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">@lang('messages.general_journal_ledger')</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <form action="{{ route('generalJournal.ledger.report') }}" method="get" id="form-search" target="_blank">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6" style="margin-top: 25px;">
                    ...
                    @if (request()->hasAny(['party_id', 'from_date', 'to_date']))
                        <a href="{{ route('generalJournal.ledger') }}" class="btn btn-secondary">@lang('messages.clear')</a>
                    @endif
                </div>
            </div>
        </form>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const inputs = ['from_date', 'to_date'];

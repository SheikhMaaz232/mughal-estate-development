...
class CashPaymentVoucherRequest extends FormRequest
{
    /**
     ...
     public function rules(): array
    {
        return [
            ...
            'cash_account_id'           => 'required|exists:detail_accounts,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'cash_account_id.required'           => __('messages.cash_account_required'),

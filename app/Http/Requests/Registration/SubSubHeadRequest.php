...
class SubSubHeadRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name_en' => [
                ...
                'string',
                'max:255',
                Rule::unique('sub_sub_heads', 'name_en')->ignore($id)->whereNull('deleted_at'),
            ],
            'name_ur' => [
                'required',
                'string',
                'max:255',
                Rule::unique('sub_sub_heads', 'name_ur')->ignore($id)->whereNull('deleted_at'),
            ],
        ];
    }

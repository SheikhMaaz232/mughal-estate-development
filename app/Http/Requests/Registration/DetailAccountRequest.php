...
class DetailAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name_en' => [
                ...
                'string',
                'max:255',
                Rule::unique('detail_accounts', 'name_en')->ignore($id)->whereNull('deleted_at'),
            ],
            'name_ur' => [
                'required',
                'string',
                'max:255',
                Rule::unique('detail_accounts', 'name_ur')->ignore($id)->whereNull('deleted_at'),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'sub_sub_sub_head_id.required' => __('messages.select-sub-sub-sub-heads'),
            ...
            'party_id.required' => __('messages.select-party'),
        ];
    }
}

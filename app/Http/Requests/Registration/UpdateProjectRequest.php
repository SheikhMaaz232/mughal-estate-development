...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'roads_area' => 'required|integer|min:0',
            'park_area' => 'required|integer|min:0',
            'cemetery_area' => 'required|integer|min:0',
            'mosque_area' => 'required|integer|min:0',
            'social_waste_area' => 'required|integer|min:0',
            'disposable_area' => 'required|integer|min:0',
            'commercial_area' => 'required|integer|min:0',
            'residential_area' => 'required|integer|min:0',
            'total_area' => 'required|integer|min:0',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'disposable_area.required' => __('messages.disposable_area.required'),
            'disposable_area.numeric' => __('messages.disposable_area.numeric'),
            'disposable_area.min' => __('messages.disposable_area.min'),
            'commercial_area.required' => __('messages.commercial_area.required'),
            'commercial_area.numeric' => __('messages.commercial_area.numeric'),
            'commercial_area.min' => __('messages.commercial_area.min'),
            'residential_area.required' => __('messages.residential_area.required'),
            'residential_area.numeric' => __('messages.residential_area.numeric'),
            'residential_area.min' => __('messages.residential_area.min'),
